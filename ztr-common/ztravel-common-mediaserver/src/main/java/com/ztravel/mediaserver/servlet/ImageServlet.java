...
import com.ztravel.mediaserver.consts.Consts;
...
import com.ztravel.mediaserver.service.ImageLoadService;
...
public class ImageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		byte[] contentBytes;
		try {
		    if (mediaImageId.startsWith("http://") || mediaImageId.startsWith("https://")) {
		        HttpClient client = new HttpClient();
		        GetMethod get = new GetMethod(mediaImageId);
