...
public class BackCustomerGlobalExceptionHandler implements HandlerExceptionResolver {
	
	private static final Logger LOG = RequestIdentityLogger.getLogger(BackCustomerGlobalExceptionHandler.class);
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		ModelAndView mv = new ModelAndView("/common/opera/err");
