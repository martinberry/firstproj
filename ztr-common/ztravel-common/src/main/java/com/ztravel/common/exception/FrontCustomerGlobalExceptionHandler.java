...
public class FrontCustomerGlobalExceptionHandler implements HandlerExceptionResolver {
	
	private static final Logger LOG = RequestIdentityLogger.getLogger(FrontCustomerGlobalExceptionHandler.class);
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		ModelAndView mv = new ModelAndView("/common/front/error/500");
