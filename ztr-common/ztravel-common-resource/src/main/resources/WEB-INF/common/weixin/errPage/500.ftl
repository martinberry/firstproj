...
<body class="workError-bg">
<header>
    <div class="head clearfix">
        <a href="${wxServer}/weixin/product/list">
		  <div class="logo"></div>
		</a>
    </div>
</header>
<div class="workError-tips">
    <div class="workError-txt">网站打了个盹,请稍后重试</div>
    <div class="backHomeBtn"><a class="backlink" href="${wxServer}/weixin/product/list">回到首页</a></div>
</div>
<div class="workError-btm"></div>
</body>
</html>