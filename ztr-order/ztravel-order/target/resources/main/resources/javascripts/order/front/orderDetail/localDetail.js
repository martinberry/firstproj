...
function saveContactInfo(){
	 ...
	 $.ajax({
		   type: "POST",
		   url: basepath + '/localorder/front/contactor/update',
		   headers : {
...
function getContactInfoList(){
	var orderId = $.trim($('input[name="orderId"]').val());
	 $.ajax({
		   type: "POST",
		   url: basepath + '/localorder/front/contactor/list',
		   headers : {
				'Accept' : 'application/json',
				'Content-Type' : 'application/json'
			},
...
function saveTouristInfo(){
	...
	list.passengers = passengers;
	 ...
	 $.ajax({
		   type: "POST",
		   url: basepath + '/localorder/front/passenger/update',
		   headers : {
				'Accept' : 'application/json',
				'Content-Type' : 'application/json'
			},
...
function getTouristInfoList(){
	var orderId = $.trim($('input[name="orderId"]').val());
	 $.ajax({
		   type: "POST",
		   url: basepath + '/localorder/front/passenger/list',
		   headers : {
				'Accept' : 'application/json',
				'Content-Type' : 'application/json'
			},
...
function ajaxLoadProvince(){
	$.ajax({
	    type: "POST",
	    url: basepath + '/localorder/front/loadProvince',
//	    data: {},
	    headers : {
		    'Accept' : 'application/json',
		    'Content-Type' : 'application/json'
...
function ajaxLoadCity(provinceName){
	...
	if(provinceName !=''){
			$.ajax({
		    type: "POST",
		    url: basepath + '/localorder/front/loadCity',
		    data: provinceName,
		    headers : {
			    'Accept' : 'application/json',
			    'Content-Type' : 'application/json'
...
function ajaxLoadCounty(cityName){
	if(cityName !=''){
			$.ajax({
		    type: "POST",
		    url: basepath + '/localorder/front/loadCounty',
		    data: cityName,
		    headers : {
			    'Accept' : 'application/json',
			    'Content-Type' : 'application/json'
