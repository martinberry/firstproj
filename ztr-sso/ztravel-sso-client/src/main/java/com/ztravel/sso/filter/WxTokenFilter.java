...
/**
 * Token filter 生成一个新的会话id，并做成线程安全的存取
 * @author liuzhuo
 *
 */

public class WxTokenFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if(cookie == null) {
			cookie = CookieFactory.buildWxToken(UUID.randomUUID().toString()) ;
			res.addCookie(cookie);
		}

		TokenHolder.set(cookie.getValue());
