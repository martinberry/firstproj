...
//                introspectedTable, true);
    ...
    private Method getSingleValueMethod(IntrospectedColumn introspectedColumn,
        ...
        sb.append(Ibatis3FormattingUtilities.getAliasedActualColumnName(introspectedColumn));
        sb.append(' ');
        sb.append(operator);
        sb.append("\", "); //$NON-NLS-1$
     ...
     * @param constructor
     * @param innerClass
     * @return the name of the List added to the class by this
     *         method
     */
    private String addtypeHandledObjectsAndMethods(IntrospectedColumn introspectedColumn,
        ...
        sb.setLength(0);
        sb.append(field.getName());
        sb.append(".add(new Criterion(condition, value));"); //$NON-NLS-1$
        method.addBodyLine(sb.toString());
        innerClass.addMethod(method);
        ...
        sb.setLength(0);
        sb.append(field.getName());
        sb.append(".add(new Criterion(condition, value1, value2));"); //$NON-NLS-1$
        method.addBodyLine(sb.toString());
        innerClass.addMethod(method);
