...
public class TableConfiguration extends PropertyHolder {
     ...
     * 是否开启jdbctype
     */
    private boolean jdbcTypeEnabled;
	 ...
	 * 是否开启jdbctype
	 */
	public boolean isJdbcTypeEnabled() {
		return jdbcTypeEnabled;
	}

	/**
	 * 是否开启jdbctype
	 */
	public void setJdbcTypeEnabled(boolean jdbcTypeEnabled) {
		this.jdbcTypeEnabled = jdbcTypeEnabled;
	}
