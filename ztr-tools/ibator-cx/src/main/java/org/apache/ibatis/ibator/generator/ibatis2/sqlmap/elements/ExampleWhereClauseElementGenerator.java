...
public class ExampleWhereClauseElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id",  XmlConstants.COMMON + "."+introspectedTable.getExampleWhereClauseId())); //$NON-NLS-1$
        ...
        innerIterateElement.addElement(new TextElement(
                "<![CDATA[ $oredCriteria[].criteriaWithoutValue[]$ ]]>")); //$NON-NLS-1$
        ...
        innerIterateElement
                .addElement(new TextElement(
                        "<![CDATA[ $oredCriteria[].criteriaWithSingleValue[].condition$ #oredCriteria[].criteriaWithSingleValue[].value# ]]>")); //$NON-NLS-1$
        isEqualElement.addElement(innerIterateElement);
        ...
        innerIterateElement.addAttribute(new Attribute("conjunction", "and")); //$NON-NLS-1$ //$NON-NLS-2$
        innerIterateElement.addElement(new TextElement(
                "<![CDATA[ $oredCriteria[].criteriaWithListValue[].condition$ ]]>")); //$NON-NLS-1$
        ...
        innerInnerIterateElement.addElement(new TextElement(
                "<![CDATA[ #oredCriteria[].criteriaWithListValue[].values[]# ]]>")); //$NON-NLS-1$
        ...
        innerIterateElement.addAttribute(new Attribute("conjunction", "and")); //$NON-NLS-1$ //$NON-NLS-2$
        innerIterateElement.addElement(new TextElement("<![CDATA["));
        innerIterateElement.addElement(new TextElement(
