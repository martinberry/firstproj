...
//                introspectedTable);
        ...
        method.addParameter(new Parameter(field
        		.getType(), "criteriaWithoutValue"));
        method.addBodyLine("this.criteriaWithoutValue = criteriaWithoutValue;"); //$NON-NLS-1$
        answer.addMethod(method);
//
...
//
        ...
        method.setName(JavaBeansUtil.getSetterMethodName(field.getName()));
        method.addParameter(new Parameter(field
        		.getType(), "criteriaWithSingleValue"));
        method.addBodyLine("this.criteriaWithSingleValue = criteriaWithSingleValue;"); //$NON-NLS-1$
        answer.addMethod(method);
//
        field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        ...
        method.setName(JavaBeansUtil.getSetterMethodName(field.getName()));
        method.addParameter(new Parameter(field
        		.getType(), "criteriaWithListValue"));
        method.addBodyLine("this.criteriaWithListValue = criteriaWithListValue;"); //$NON-NLS-1$
        answer.addMethod(method);
//
        field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        ...
        method.setName(JavaBeansUtil.getSetterMethodName(field.getName()));
        method.addParameter(new Parameter(field
        		.getType(), "criteriaWithBetweenValue"));
        method.addBodyLine("this.criteriaWithBetweenValue = criteriaWithBetweenValue;"); //$NON-NLS-1$
        answer.addMethod(method);
//
