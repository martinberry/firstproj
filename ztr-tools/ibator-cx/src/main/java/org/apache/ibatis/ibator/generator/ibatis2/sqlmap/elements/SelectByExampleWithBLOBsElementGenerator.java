...
public class SelectByExampleWithBLOBsElementGenerator extends
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id",  introspectedTable.getIbatis2SqlMapNamespace() + "."+introspectedTable.getSelectByExampleWithBLOBsStatementId())); //$NON-NLS-1$
        answer.addAttribute(new Attribute(
        ...
        includeElement.addAttribute(new Attribute("refid", //$NON-NLS-1$
        		XmlConstants.COMMON + "." + introspectedTable.getExampleWhereClauseId())); //$NON-NLS-1$
        ...
        isNotNullElement
                .addElement(new TextElement("<![CDATA[ order by $orderByClause$ ]]>")); //$NON-NLS-1$
