...
public class InsertSelectiveElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id",  introspectedTable.getIbatis2SqlMapNamespace() + "."+introspectedTable.getInsertSelectiveStatementId())); //$NON-NLS-1$
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable.getAllColumns()) {
            ...
            valuesNotNullElement.addElement(new TextElement("<![CDATA[ "+Ibatis2FormattingUtilities.getParameterClause(introspectedColumn)+" ]]>"));
