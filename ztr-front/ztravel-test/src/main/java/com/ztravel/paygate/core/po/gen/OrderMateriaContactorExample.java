...
public class OrderMateriaContactorExample {
    ...
    public OrderMateriaContactorExample() {
        oredCriteria = new ArrayList<Criteria>();
    }

    protected OrderMateriaContactorExample(OrderMateriaContactorExample example) {
