                        ...
                        <div class="leftHotelImg">
                          <div class="hotelTitleModel clearfix">
                            ...
                            <div class="hotelBigImg">
                                <img <#if hotel.pictureIds[0]??>data-original="${mediaserver}imageservice?mediaImageId=${(hotel.pictureIds[0])!}" class="lazyload-img"</#if>>
                            </div>
                            <ul class="hotelSmallImg clearfix">
                            <#list (hotel.pictureIds)! as pictureId>
                    	         <li <#if pictureId_index == 0>class="active"</#if> ><img data-original="${mediaserver}imageservice?mediaImageId=${pictureId!}" class="lazyload-img"></li>
                            </#list>
                            </ul>
                        </div>
