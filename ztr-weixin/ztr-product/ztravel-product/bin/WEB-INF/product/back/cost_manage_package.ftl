...
<@html.htmlIndex jsFiles=["common/pagination.js","product/back/cost_manage_common.js","product/back/cost_manage_package.js","product/back/common.js","js/vendor/bootstrap-datepicker.min.js","js/vendor/bootstrap-datepicker.zh-CN.min.js","js/vendor/underscore.js"]
    ...
    <div class="main-container changeMainContent">
		<span id="data" name="data" style="display:none ;">${cost.costs!'{}'}</span>
		...
		<input type='hidden' id='packageSingleDay' value="">
		<input type='hidden' id='producttype' value="package">
		
		<input type='hidden' id='old_shuttle_supplier' value="">
		<input type='hidden' id='old_wifi_supplier' value="">
		<input type='hidden' id='old_other_supplier' value="">
		<input type='hidden' id='old_zenbook_supplier' value="">
            <section class="whiteBg">
                ...
                <section class="pm-info-module price-info-module" style="width:1300px">
                    <div class="sub-title">成本维护</div>
                    <section class="pack-price-block" style="width:1300px">
                    	<div class="radioContent priceOperType">
                        ...
                        <div class="price-maint-block">
                         	<!--  批量修改  -->
                            <div class="batch-oper-block">
	                            <div class="date-oper-line">
	                                <span>打包成本</span>
	                                <input type="text" class="datepicker hasIcon startDate" style="width:150px;" /> 至
	                                <input type="text" class="datepicker hasIcon endDate" style="width:150px;"/>
	                                <span class="checkboxContent week-date">
	                                ...
	                                <span class="oper-price-btn">
	                                    <button class="commonButton blue-45c8dcButton cost add batch">添加成本</button>
	                                    <button class="commonButton blue-45c8dcButton cost remove batch">清除成本</button>
	                                </span>
	                            </div>
	                        ...
	                        <!--  单日修改  -->
                            <div class="single-oper-block" style="display:none;">
                                <span>打包成本</span>
                                <span class="adult-price-text">成人票价</span>
                                ...
                                <span class="oper-price-btn">
                                    <button class="commonButton blue-45c8dcButton cost add single">添加成本</button>
                                    <button class="commonButton blue-45c8dcButton cost remove single">清除成本</button>
                                </span>
                            </div>
                        </div>
                        <div class="double-price-calendar clearfix" style="margin-left:60px;">
                        ...
                        <span class="provider">
                            ...
                            <div class="dropdown" style="width: 320px;top:1px;">
                                <a href="javascript:void(0);" class="dropdownBtn" data-toggle="dropdown" aria-expanded="true">
                                    <span class="activeFonts">${(cost.packageSupplier.supplierName)!""}</span>
                                    <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <#list cost.allSuppliers as supplier>
										<li onclick=setDropDownMenu(this,'${supplier.supplierId}','${supplier.supplierNameTransfer}','#packageSupplierId');><a href="javascript:void(0);">${supplier.supplierName}</a></li>
									</#list>
                                </ul>
                                <input type="hidden" id='packageSupplierId' value='${(cost.packageSupplier.supplierId)!""}'>
                            </div>
                        </span>
                    </section>
    ...
    <script type="text/html" id="transfer_flight_template_front">
        <section class="transfer-flight-block transfer clearfix">
    ...
    <script>
    	$(function(){
			...
			geneDoublePriceCalendar(".double-price-calendar", strToJson($("#data").html()));
    	}) ;
    </script>
