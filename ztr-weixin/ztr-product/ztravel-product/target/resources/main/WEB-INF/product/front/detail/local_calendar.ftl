<#macro priceCalendar>
<script type="text/javascript" src="${basepath}/resources/javascripts/product/front/local_calendar.js"></script>
...
<input type="hidden" name="productNature" id="productNature" value="${(product.productNature)!''}">      
            ...
            <div class="panelWrap-head">           
                ...
                <div id="childDiv" class="panelWrap-box-child" style="display:block;">
            ...
            <div class="visaSubmit">
                <a href="javascript:void(0);" class="bigOrangeBtn active" id="orderinstance">立即预订</a><span class="dateTips" style="display:none;">日期选择错误，请重新选择</span>
            </div>
            <div id="leftFlag"></div>
          </div> 
</#macro>          
