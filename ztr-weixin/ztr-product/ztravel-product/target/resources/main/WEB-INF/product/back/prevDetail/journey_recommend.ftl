<#macro journeyRecommend>
               ...
               <div class="commonModel journeyRecommendModel">
                    ...
                    <div class="clearfix">
                        ...
                        <img src="${mediaserver}imageservice?mediaImageId=${(product.recommendTrips[0].desItems[0].images[0])!}" class="overviewImg" />
                            ...
                            <ul class="wrapperList overviewBlock">
                                ...
                                <li class="row twoRow overviewRight">
                                    ...
                                    <div class="tipsContentBlock">
                                        ...
                                        <div style="display: none;"><ul class="listDetails"><#noescape>${(product.travelTips['COMMUNICATION'])!}</#noescape></ul></div>
                    	...
                    	<li<#if product.tripDays==index> class="last"</#if>>
                            ...
                            <#if trip.hotelInfo??>
	                            ...
	                            <div class="daysImg">
		                            ...
		                            <img src= "${mediaserver}imageservice?mediaImageId=${img!}">
		                            </#list>
	                            </div>
