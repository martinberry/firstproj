          ...
          <div class="innerModel">
                  ...
                  <#if recProducts??>
	          	    <#list recProducts as recProduct>
	          	    	...
	          	    	<li>
	          	    	<#assign urlPath="product/front/detail"/>
	          	    	<#if (recProduct.productType)=='VISA'>
	          	    	<#assign urlPath="product/visa/detail"/>
	          	    	<#elseif (recProduct.productType)=='UNVISA'>
                        <#assign urlPath="localproduct/front/detail"/>
	          	    	</#if>
	                      <a href="${memberServer}/${urlPath}/${(recProduct.productId)!}" target="_blank">
	                          ...
	                          <div <#if (recProduct.productType)=='TRAVEL'>class="bgShade hovercon"<#else>class="noBgShade hovercon"</#if>>
	                              <h4>行程亮点</h4>
