...
import com.dianping.cat.CatRpcRecorder;
...
public class CatMonitorAspect {
	...
	public Object doAround(ProceedingJoinPoint point) throws Throwable {
		...
		if (StringUtils.isNotBlank(CatRpcRecorder.getCurrentId()))
			Cat.getManager().getThreadLocalMessageTree().setMessageId(CatRpcRecorder.getCurrentId());
