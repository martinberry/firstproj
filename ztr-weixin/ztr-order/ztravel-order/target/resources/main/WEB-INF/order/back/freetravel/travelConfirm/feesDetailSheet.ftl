...
<div class="commonOPOrderModel paddingBottom20">
    <div class="commonSmallTitleModel blueFonts">
        <span class="leftTitleFonts">价格明细</span>
        <label class="commonEditBtn priceEditBtn" <#if (readOnly)!false > style="display: none;" </#if>>
            <span class="commonIcon editIcon"></span>
        </label>
    </div>
    <div class="commonStyle">
        <table class="commonLightBlueThead leftTh feesDetailTab width90">
            <colgroup>
                <col width="160">
                <col width="230">
                <col width="320">
        ...
        <div class="commonSave requiredSave">
            <a href="javascript:void(0);" class="commonBtn blueBtn">保 存</a>
            <a href="javascript:void(0);" class="cancelBtn"  id="cancelFeesDetailBtn">取消</a>
        </div>
		<#if (readOnly)!false >
		...
		<div class="emailTab">
			...
			<tr>
			    <th>用户邮箱:</th>
			    <td>
			        <input type="email" name="contactorEmail" style="width: 220px;">
			    </td>
			</tr>
			<tr style="display:none;">
			    <th class="verticalAlignTop">备注:</th>
			    <td>
			        <textarea></textarea>
			    </td>
			</tr>
