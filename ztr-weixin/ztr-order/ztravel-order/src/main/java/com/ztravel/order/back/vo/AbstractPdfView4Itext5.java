 ...
 * 上面是itext2的实现，替换成itext5的实现
 *
 */
public abstract class AbstractPdfView4Itext5 extends AbstractView {
	...
	public ByteArrayOutputStream document2ByteArrayOutputStream() throws Exception{
		ByteArrayOutputStream baos = createTemporaryOutputStream();
		Document document = newDocument();
		PdfWriter writer = newWriter(document, baos);
	...
	protected void buildPdfDocument(Document document, PdfWriter writer) throws Exception{
		buildPdfDocument(null, document, writer, null, null) ;
	}
