...
<div class="main-container">
  ...
  <div class="main-container">
      ...
      <section>
		  ...
		  <#if (RecProductEntity_index)/3=1>
              <ul class="hot_route" style="margin-bottom:10px;">
          <#elseif (RecProductEntity_index)%3=0>
              <ul class="hot_route">
           <#else>
           </#if>
                  <li>
                      <a href="javascript:void(0);">
                          <img src="${mediaserver}imageservice?mediaImageId=${(RecProductEntity.pictureId)!}"/>
                          <span class="priceTips">¥${(RecProductEntity.lowestPrice)!}<em>起</em></span>
                          <div class="bgShade hovercon">
                              <h4>行程亮点</h4>
                              <div class="innerContent">
                              <#if (RecProductEntity.highLights)??>
                              <#list RecProductEntity.highLights as hl>
                                  <p>${hl!}</p>
                               </#list>
                               </#if>
                              </div>
                              ...
                              <div class="minBox">
                            	  <#if (RecProductEntity.tags)??>
	                              	  	<#list RecProductEntity.tags as tag>
	                                  	<i>${tag!}</i>
	                                  	</#list>
	                                  </#if>
                              </div>
                      ...
                      <p class="product-descr">${(RecProductEntity.mainTitle)!}</p>
                      <p class="product-days">${(RecProductEntity.viceTitle)!}</p>
                  </li>


             <#if (RecProductEntity_index+1)%3=0>
              </ul>
			  </#if>
                </#list>
