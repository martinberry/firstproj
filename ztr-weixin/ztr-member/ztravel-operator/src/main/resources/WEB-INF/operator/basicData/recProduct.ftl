           ...
           <section class="whiteBg">
                ...
                <div class="material-table-container">
                    ...
                    <div class="tabTitle clearfix changeWidth">
                        ...
                        <span class="title04">产品类型</span>
                        <span class="title05">产品ID</span>
                        <span class="title06">产品图片</span>
                        <span class="title07">操作</span>
                    </div>
...
<!-- 添加组模板     -->
                <div class="material-info-item-addgroup changeWidth clearfix" style="display:none">
                                    ...
                                    <div class="commonStyle row04">
                                        <div class="dropdown first-menu-action">
                                            <a href="javascript:void(0);" data-toggle="dropdown" class="dropdownBtn">
                                                <#if (RecProductEntity.productType)??>
                                                    <#if (RecProductEntity.productType) == 'VISA'>
                                                    <span class="activeFonts">签证产品</span>
                                                    <#elseif (RecProductEntity.productType) == 'UNVISA'>
                                                    <span class="activeFonts">当地游产品</span>
                                                    <#else>
                                                    <span class="activeFonts">自由行</span>
                                                    </#if>
                                                <#else>
                                                <span class="activeFonts">自由行</span>
                                                </#if>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li value="TRAVEL" <#if !(RecProductEntity.productType)?? || (RecProductEntity.productType) == 'TRAVEL'>class="active"</#if>><a href="javascript:void(0);">自由行</a></li>
                                                <li value="VISA" <#if (RecProductEntity.productType)?? && (RecProductEntity.productType) == 'VISA'>class="active"</#if>><a href="javascript:void(0);">签证产品</a></li>
                                                <li value="UNVISA" <#if (RecProductEntity.productType)?? && (RecProductEntity.productType) == 'UNVISA'>class="active"</#if>><a href="javascript:void(0);">当地游产品</a></li>
                                            </ul>
                                        </div>
                                    </div>
                   ...
                   <div class="commonStyle row06 upLoadProductImg">
                            ...
                            <#else>
                            <div class="commonStyle row06 instantUpload">
                                <form name="pictureform" action="${basepath}/product/back/hotel/uploadPicture" method="post" enctype="multipart/form-data">
