...
<@html.htmlIndex curModule="用户" title="找回密码-新密码" jsFiles=["member/front/common_utils.js", "member/front/reset_password_email.js","common/password_verify.js"] cssFiles=["css/client/register.css"]>
