<#macro priceCalendar>
<script type="text/javascript" src="${basepath}/resources/javascripts/product/front/detail_calendar.js"></script>
    ...
    <div class="right-order-info">
        ...
        <div class="order-block">
            ...
            <!--<div class="menu-price">
                <span class="title">套餐总价:</span>
                <span class="menu-price-text">￥<span id="currentTotalPrice"></span><em></em></span>
                <span class="menu-price-tooltip green-border-tooltip" id="currentSavePrice" title="本产品当日市场人均单价为M元，真旅行一共给您省了X元。不谢~">共省<em></em>大洋!</span>
                <span style="display:none;">本产品当日市场人均单价为M元，真旅行一共给您省了X元。不谢~</span>
            </div>-->
            ...
            <div class="share-info">
                ...
                <span class="wishlist<#if isWish==true> actived</#if>"></span>
