...
<@html.htmlIndex title="签证首页"
		  	...
		  	localJsFiles=["product/weixin/list/visaList.js"]>
<div class="viewport" data-role="page">
    <@head.headerBar title="签证首页" menuType="VISA"></@head.headerBar>
    <div class="visaTrip-wrap">
        <div class="visaTrip-box">
            <ul class="visaTrip-list clearfix">
            </ul>
        </div>
    </div>
